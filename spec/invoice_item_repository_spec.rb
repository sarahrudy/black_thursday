...
RSpec.describe InvoiceItemRepository do
  ...
  describe 'invoice items repository methods' do
    ...
    it 'finds all invoice item by item id' do
      ...
      invoice_item_2 = invoice_item_repository.find_by_id(21_831)
      invoice_item_3 = invoice_item_repository.find_by_id(21_832)
    ...
    it 'finds all invoice item by invoice id' do
      invoice_item_1 = invoice_item_repository.find_by_id(21_831)
    ...
    it 'can delete invoice item' do
      invoice_item_1 = invoice_item_repository.find_by_id(21_832)
