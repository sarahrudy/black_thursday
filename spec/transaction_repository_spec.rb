...
RSpec.describe TransactionRepository do
  ...
  describe 'transaction repository methods' do
    ...
    it 'find all by invoice_id' do
      ...
      expect(transaction_repository.find_all_by_invoice_id(transaction_1.invoice_id)).to eq([transaction_1,transaction_2,transaction_3])
    end
    ...
    it 'find all by credit_card_number' do
      ...
      expect(transaction_repository.find_all_by_credit_card_number(transaction_1.credit_card_number)).to eq([transaction_1, transaction_2, transaction_3])
    end
